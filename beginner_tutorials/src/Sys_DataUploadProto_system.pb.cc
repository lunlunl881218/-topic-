...
void TC397_Sys_Tasktime_message::SerializeWithCachedSizes(
  ...
  if (this->u64aplbehaviorplantask100ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(1, this->u64aplbehaviorplantask100ms_period(), output);
  }

  // uint64 u64AplCommMgrTask10ms_period = 2;
  if (this->u64aplcommmgrtask10ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(2, this->u64aplcommmgrtask10ms_period(), output);
  }

  // uint64 u64AplLateralCtrlTask10ms_period = 3;
  if (this->u64apllateralctrltask10ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(3, this->u64apllateralctrltask10ms_period(), output);
  }

  // uint64 u64AplMotionPlanTask100ms_period = 4;
  if (this->u64aplmotionplantask100ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(4, this->u64aplmotionplantask100ms_period(), output);
  }

  // uint64 u64AplSafetyCtrlTask50ms_period = 5;
  if (this->u64aplsafetyctrltask50ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(5, this->u64aplsafetyctrltask50ms_period(), output);
  }

  // uint64 u64AplSystemMgrTask50ms_period = 6;
  if (this->u64aplsystemmgrtask50ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(6, this->u64aplsystemmgrtask50ms_period(), output);
  }

  // uint64 u64AplVerticalCtrlTask10ms_period = 7;
  if (this->u64aplverticalctrltask10ms_period() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(7, this->u64aplverticalctrltask10ms_period(), output);
  }

  // uint64 u64AplBehaviorPlanTask100ms_time_diff = 8;
  if (this->u64aplbehaviorplantask100ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(8, this->u64aplbehaviorplantask100ms_time_diff(), output);
  }

  // uint64 u64AplCommMgrTask10ms_time_diff = 9;
  if (this->u64aplcommmgrtask10ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(9, this->u64aplcommmgrtask10ms_time_diff(), output);
  }

  // uint64 u64AplLateralCtrlTask10ms_time_diff = 10;
  if (this->u64apllateralctrltask10ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(10, this->u64apllateralctrltask10ms_time_diff(), output);
  }

  // uint64 u64AplMotionPlanTask100ms_time_diff = 11;
  if (this->u64aplmotionplantask100ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(11, this->u64aplmotionplantask100ms_time_diff(), output);
  }

  // uint64 u64AplSafetyCtrlTask50ms_time_diff = 12;
  if (this->u64aplsafetyctrltask50ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(12, this->u64aplsafetyctrltask50ms_time_diff(), output);
  }

  // uint64 u64AplSystemMgrTask50ms_time_diff = 13;
  if (this->u64aplsystemmgrtask50ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(13, this->u64aplsystemmgrtask50ms_time_diff(), output);
  }

  // uint64 u64AplVerticalCtrlTask10ms_time_diff = 14;
  if (this->u64aplverticalctrltask10ms_time_diff() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(14, this->u64aplverticalctrltask10ms_time_diff(), output);
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt64Parser(mutable_u64reserve1(), ptr, ctx);
          CHK_(ptr);
